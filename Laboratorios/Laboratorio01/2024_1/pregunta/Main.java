...
class Principal{
/* Coloque sus datos
Nombre Completo: Jesus Mauricio Huayhua Flores
Código PUCP: 20196201
*/
public static void main(String[] args) throws Exception{
	...
	//Creamos una atencion medica de tipo Examen Diagnostico para el 30 de Marzoa las 08:30
